  ...
  return (
    <div className="flex flex-col">
      <div className='flex flex-row justify-between'>
        <h1 className="md:text-3xl text-2xl font-medium flex gap-1">Hi, I'm Hafidz <p className="animate-shake">👋</p></h1>
        {/* <Coffee /> */}
      </div>
      <ul className='flex md:space-x-8 space-x-0 px-5 py-2 md:flex-row flex-col '>
        <li className='list-disc text-md'>Junior Front End Dev</li>
        <li className='list-disc text-md'>Based in Malang 🇮🇩</li>
      </ul>
